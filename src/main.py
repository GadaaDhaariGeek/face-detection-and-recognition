...
# python src/main.py -i2 "data/john_snow_single.jpg" -i1 "data/john_snow_ygritte.jpg" 

# print(args.image1, args.image2, args.video, args.scale, args.face_detection_model, args.face_recognition_model, args.score_threshold, args.nms_threshold, args.top_k, args.save)
# import sys
# sys.exit(0)
